<x-admin-layout>
    <x-slot name="title">Export data By channel </x-slot>
    <div class="container bg-white py-4 px-3">
        <div class="row mb-3">
            <div class="col-6">
                Export by channel {{ request('year') ?? 'all year' }}:
                <a href="{{ route('export-bychannel-cetak', [request('year') ?? 2022]) }}" class="btn btn-success">
